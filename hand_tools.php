...
<Body>
    ...
    <div class="whole-div">
        ...
        <?php   
				...
				$query = $conn->prepare("SELECT * FROM `hand` WHERE `Price` LIKE '%$keyword%' or `Name` LIKE '%$keyword%' or `ship_order` LIKE '%$keyword%'");
				$query->execute();
        ...
        ?>  
                <tr>
                    ...
                    <td>
                        <a href="delete_tool.php?ID=<?php echo $sfter['ID']."&address=hand"?>" onclick="return  confirm('Do you want to delete this data?')" class="delete.a" style="color: red;"> Delete </a>
                        <a href="edit_tool.php?ID=<?php echo $sfter['ID']."&address=hand"?>" style="color: blue;">Edit</a>
                    </td>
                </tr>
        <?php
                }
                    ...
                    <thead>
                        ...
                        ?>
                            <td>
                                ...
                                <a href="delete_tool.php?ID=<?php echo $row['ID']."&address=hand"?>" onclick="return  confirm('Do you want to delete this data?')" class="delete.a" style="color: red;"> Delete </a>
                                <a href="edit_tool.php?ID=<?php echo $row['ID']."&address=hand" ?>" style="color: blue;">Edit</a>
                            </td>
                            </tr>
                    <?php
                        }
